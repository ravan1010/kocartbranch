      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t pb-4">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <NavLink to="/branch" className={({ isActive }) => `block px-3 py-2 rounded-md text-base font-medium ${isActive ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700'}`} onClick={() => setIsOpen(false)}>Dashboard</NavLink>
